...
**There is a new version of this kit available.** [Please check it out 
here](https://github.com/makerkit/next-supabase-saas-kit-turbo)**

If you are starting a new project, we recommend using the new version.
