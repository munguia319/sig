...
create table if not exists organizations_subscriptions (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.email_signatures (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.public_signature_links (
